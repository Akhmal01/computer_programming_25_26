...
print("petal_length_text:", petal_length_2, "| type:", type(petal_length_2))
print("threshold_text:", "2.0", "| type:", type("2.0"))
print("threshold_number:", threshold, "| type:", type(threshold))

petal_area_2 = float(petal_length_2) * petal_width_2
